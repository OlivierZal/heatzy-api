...
// mechanism this directory used to carry as melcloud-api's
// byte-identical twin): the Gizwits sensitive-key set lives in
// `context.ts`, and the shells re-exported here arrive pre-bound to it.
